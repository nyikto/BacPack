...
var petri1 = createPetriDish(rootW / 5, rootH / 3, Math.PI / 2);
...
function createClearButton(petriDish, width, height) {
	...
	w.setHeight(height);
	w.setFixed();
	w.setLocation(petriDishW, petriDishH - height);
	w.setBackgroundColor(0, 0, 0, 0);
...
function createInfoButton(petriDish, width, height) {
	...
	w.setHeight(height);
	w.setFixed();
	w.setLocation(petriDishW, petriDishH - height * 2);
	w.setBackgroundColor(0, 0, 0, 0);
...
function createFlask(petriDish, width, height) {
	...
	w.setHeight(650 / 3);
	w.setFixed();
	w.setLocation(petriDishW + petriDish.clearButton.width(), 0);
	w.setBackgroundColor(0, 0, 0, 0);
